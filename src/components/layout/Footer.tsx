...
export function Footer() {
  ...
  const FOOTER_LINKS = {
    ...
    [tt(t.footer.exploreSection)]: [
      ...
      { href:'/assessment',        label:tt(t.footer.assessmentSystem) },
      { href:'/geometry-center',   label:tt(t.footer.geometryCenterNav) },
      { href:'/linear-algebra-center', label:tt(t.footer.linearAlgebraCenterNav) },
      { href:'/statistics',        label:tt(t.footer.statistics) },
      { href:'/probability-center', label:tt(t.footer.probabilityCenterNav) },
      { href:'/modeling-center',   label:tt(t.footer.modelingCenterNav) },
      { href:'/applied',           label:tt(t.footer.appliedMath) },
      { href:'/applied-math-lab',  label:tt(t.footer.appliedMathLabNav) },
      { href:'/real-life',         label:tt(t.footer.realLifeNav) },
      { href:'/career-path',       label:tt(t.footer.careerPathNav) },
      { href:'/experience-zone',   label:tt(t.footer.experienceZoneNav) },
    ...
    [tt(t.footer.practiceSection)]: [
      ...
      { href:'/puzzles',           label:tt(t.footer.mathPuzzles) },
      { href:'/ai-tutor',          label:tt(t.footer.aiTutor) },
      { href:'/ai-problem-solver', label:tt(t.footer.aiProblemSolverNav) },
