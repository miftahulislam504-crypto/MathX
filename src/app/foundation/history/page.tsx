...
const TIMELINE = [
  ...
  },
  {
    ...
    events: [
      ...
      { year:'~850 CE', event:'Thabit ibn Qurra discovers a general formula for amicable numbers and advances geometry and mechanics.' },
      ...
      { year:'~1250 CE', event:'Nasir al-Din al-Tusi treats trigonometry as an independent discipline and gives the first full treatment of spherical trigonometry.' },
    ],
  },
  {
    ...
    events: [
      ...
      { year:'~1150 CE', event:"Bhaskara II writes the Lilavati and Bijaganita — the chakravala method for Pell's equation, and ideas that anticipate differential calculus by 500 years." },
      { year:'~1350 CE', event:'Kerala school discovers infinite series for π and trigonometric functions — 200 years before Europe.' },
    ],
  },
  {
    era: 'Chinese Mathematics',
    period: '~200 BCE–1300 CE',
    color: 'border-red-500/40 bg-red-500/8',
    dot: 'bg-red-500',
    label: 'text-red-400',
    events: [
      { year:'~200 BCE', event:'The Nine Chapters on the Mathematical Art is compiled — the foundational Chinese text, used for 1500 years, includes matrix-style methods for solving simultaneous equations.' },
      { year:'~250 CE', event:'Sun Zi poses the earliest known case of the Chinese Remainder Theorem — finding a number from its remainders under different divisors.' },
      { year:'263 CE', event:'Liu Hui writes his commentary on the Nine Chapters, approximates π ≈ 3.14159 by doubling polygon sides, and describes a method equivalent to Gaussian elimination.' },
      { year:'~480 CE', event:'Zu Chongzhi calculates π to 7 decimal places — the most accurate value in the world for the next 800 years — and finds the fraction 355/113.' },
      { year:'1247 CE', event:'Qin Jiushao publishes the complete Chinese Remainder Theorem and a Horner-like method for solving high-degree polynomial equations.' },
      { year:'1261 CE', event:"Yang Hui publishes what is now called Pascal's Triangle — about 500 years before Pascal — alongside work on magic squares and decimal fractions." },
    ],
  },
  {
